...
public class StepCountReader {
    ...
    public void requestDailyStepCount(long startTime,long endTime, final CallbackContext callbackContext) {
            // Get historical step count
            readStepDailyTrend(startTime,endTime, callbackContext);
    }
    ...
    private void readStepDailyTrend(final long startTime,final long endTime, final CallbackContext callbackContext) {
